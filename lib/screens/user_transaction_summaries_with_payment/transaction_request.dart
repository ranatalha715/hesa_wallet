                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (feesMap!['collectionMintingFee'] != null)
                                          transactionFeesWidget(
                                            title: feesMap!['collectionMintingFee']
                                                    ['label']
                                                .toString(),
                                            details: feesMap!['collectionMintingFee']
                                                    ['value']
                                                .toString(),
                                            showCurrency: true,
                                        ...
                                        if (feesMap!['assetListingFee'] != null)
                                          transactionFeesWidget(
                                            ...
                                            ['label']
                                                .toString(),
                                            details: feesMap!['assetListingFee']
                                            ['value']
                                                .toString(),
                                            showCurrency: true,
                                            isDark: themeNotifier.isDark
                                        ...
                                        if (feesMap!['collectionListingFee'] != null)
                                          transactionFeesWidget(
                                            title: feesMap!['collectionListingFee']
                                            ['label']
                                                .toString(),
                                            details: feesMap!['collectionListingFee']
                                            ['value']
                                                .toString(),
                                            showCurrency: true,
                                            isDark: themeNotifier.isDark
                                        ...
                                        if (feesMap!['burnAssetFee'] != null)
                                          transactionFeesWidget(
                                            title: feesMap!['burnAssetFee']
                                            ['label']
                                                .toString(),
                                            details: feesMap!['burnAssetFee']
                                            ['value']
                                                .toString(),
                                            showCurrency: true,
                                            isDark: themeNotifier.isDark
                                        ...
                                        if (feesMap!['purchasePrice'] != null)
                                          transactionFeesWidget(
                                            title: feesMap!['purchasePrice']
                                            ['label']
                                                .toString(),
                                            details: feesMap!['purchasePrice']
                                            ['value']
                                                .toString(),
                                            showCurrency: true,
                                            isDark: themeNotifier.isDark
                                        ...
                                        if (feesMap!['platformServiceFee'] != null)
                                          transactionFeesWidget(
                                            ...
                                            ['label']
                                                .toString(),
                                            details: feesMap!['platformServiceFee']
                                            ['value']
                                                .toString(),
                                            showCurrency: true,
                                            isDark: themeNotifier.isDark
                                        ...
                                        if (feesMap!['paymentProcessingFee'] !=
                                            null)
                                          transactionFeesWidget(
                                            title:
                                        ...
                                        if (feesMap!['totalFees'] != null)
                                          Column(children: [
                                            Divider(
                                              color: AppColors.textColorGrey,
                                            ),
                                            transactionFeesWidget(
                                              title: feesMap!['totalFees']
                                                      ['label']
                                                  .toString(),
                                              details: feesMap!['totalFees']
                                                      ['value']
                                                  .toString(),
                                              showCurrency: true,
                                              isDark: themeNotifier.isDark
                                        ...
                                        if (feesMap!['totalAmount'] != null)
                                          Column(children: [
                                            Divider(
                                              color: AppColors.textColorGrey,
                                            ),
                                            transactionFeesWidget(
                                              title: feesMap!['totalAmount']
                                              ['label']
                                                  .toString(),
                                              details: feesMap!['totalAmount']
                                              ['value']
                                                  .toString(),
                                              showCurrency: true,
                                              isDark: themeNotifier.isDark
