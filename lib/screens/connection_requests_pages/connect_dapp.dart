          ...
          return Consumer<ThemeProvider>(
              builder: (context, themeNotifier, child) {
                return Stack(
                  children: [
                    Scaffold(
                      backgroundColor: themeNotifier.isDark ? AppColors
                          .backgroundColor : AppColors.textColorWhite,
                      body: SingleChildScrollView(
                        child: Column(
                          children: [
                            MainHeader(title: 'Connection Request'.tr(),
                              handler: () =>
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      child: Container(
                                        ...
                                        Padding(
                                          padding: EdgeInsets.symmetric(
                                              horizontal: 12),
                                          child: Row(
                                            mainAxisAlignment: currentLocale
                                                .languageCode ==
                                                'en'
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                crossAxisAlignment: currentLocale
                                                    .languageCode == 'en'
                                                    ? CrossAxisAlignment
                                                    .start
                                    ...
                                    SizedBox(height: 3.h,),
                                    Text(
                                      "Information that site will utilize:"
                                          .tr(),
                                      style: TextStyle(
                                          color: AppColors.textColorWhite,
                                          fontWeight: FontWeight.w600,
                                    ...
                                    AppButton(
                                      ...
                                      handler: () async {
                                        ...
                                        var result = await Provider.of<UserProvider>(
                                            context, listen: false).connectDapps(
                                    ...
                                    AppButton(
                                        ...
                                        isGradient: false,
                                        textColor: themeNotifier.isDark ? AppColors
                                            .textColorWhite : AppColors
                                            .textColorBlack.withOpacity(0.8),
